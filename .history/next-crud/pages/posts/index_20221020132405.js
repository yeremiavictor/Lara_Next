                                    ...
                                    <tbody>
                                        {posts.map((post) =>(
                                            <tr key={post.id}>
                                                ...
                                                <td>{post.content}</td>
                                                <td className="text-center">
                                                    <button className="btn btn-sm btn-warning bordder-0 shadow-sm mb-3 me-3">Edit</button>
                                                    <button className="btn btn-sm btn-danger bordder-0 shadow-sm mb-3 me-3">Delete</button>
                                                </td>
                                            </tr>
                                        ))}
                                    </tbody>
