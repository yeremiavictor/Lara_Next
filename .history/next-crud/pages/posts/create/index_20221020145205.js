                            ...
                            <div className="card-body">
                                <form onSubmit={storePost}>
                                    ...
                                    <div className="form-group mb-3">
                                        ...
                                        <textarea name="form-control" value={content} cols="30" rows={3} onChange={(e.target.value)} placeholder='Masukan data content'></textarea>
                                    </div>
                                    {
                                        validation.content &&
                                        <div className="alert alert-danger">
                                    ...
                                    <button className="btn btn-primary border-0 shadow-sm" type='submit'></button>
                                </form>
                            </div>
                        </div>
                    </div>
